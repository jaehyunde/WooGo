      ...
      builder: (context) {
        return Container(
          ...
          child: Column(
            ...
            children: [
              Text(AppLocalizations.of(context)!.settingsAndExit, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, fontFamily: 'KidariFont')),
              SizedBox(height: 20),
              ListTile(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: AnimatedScale(
                      ...
                      child: Container(
                        decoration: BoxDecoration(boxShadow: [BoxShadow(color: Colors.black45, blurRadius: 25, offset: Offset(0, 15))]),
                        child: Image.asset('assets/images/free-icon-refrigerator-6470290.png', width: 280, fit: BoxFit.contain),
                      ),
                    ),
                  ),
                ...
                builder: (context, snapshot) {
                  ...
                  return Transform.rotate(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(color: Colors.yellow[200], boxShadow: [BoxShadow(color: Colors.black38, blurRadius: 8, offset: Offset(4, 4))]),
                      child: Column(
                        children: [
